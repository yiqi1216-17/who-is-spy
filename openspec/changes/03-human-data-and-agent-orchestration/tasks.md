...
- [ ] 5.3 Write sequential-context tests proving every later speaker sees only earlier public same-round descriptions, then replace parallel generation with deterministic seat order.
